...
export class Event extends Component {
    render() {
        const displayEvent = ['event01', 'event02', 'event03'].map((item, index) => (
                ...
                <article className='blog-card'>
                    <div className='blog-card__background'>
                        <div className='card__background--wrapper'>
                            <div
                                ...
                                style={{
                                    backgroundImage: 'url(http://demo.yolotheme.com/html/motor/images/demo/demo_131.jpg)'
                                }}>
                    ...
                    <div className='blog-card__info'>
                        ...
                        <a href='#icon3' className='btns btn--with-icon'>
                            <i className='btn-icon fas fa-long-arrow-alt-right'></i>READ MORE
                        </a>
                    </div>
                </article>
            </Col>
