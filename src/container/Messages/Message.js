...
class Message extends Component {
    ...
    render() {
        const displayMessageCard = ['card01', 'card02', 'card03', 'card04', 'card05', 'card06'].map((cards, index) => (
            <Col className='mx-auto my-3' key={index} lg={4} sm={6} data-aos='zoom-in-up'>
                    ...
                    <Row>
                        <Col className='mx-auto my-3 text-center text-capitalize'>
                            ...
                            <div className='latest-news'>
                                <marquee ref={this.marquee} onMouseEnter={() => this.marquee && this.marquee.current && this.marquee.current.stop()} onMouseLeave={() => this.marquee && this.marquee.current && this.marquee.current.start()}>
                                    <p>
