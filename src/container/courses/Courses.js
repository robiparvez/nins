...
export class Courses extends Component {
    render() {
        const displayCourse = ['course01', 'course02', 'course03', 'course04'].map((course, index) => (
            <Col xs={10} sm={6} lg={4} className='course-item mx-auto my-3' key={course + index} data-aos='fade-up'>
